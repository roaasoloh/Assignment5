...
<div class="bg-white p-8 rounded-lg max-w-4xl mx-auto">
    ...
    <div class="bg-gray-100 p-6 rounded-lg shadow mb-6">
        <h2 class="text-xl font-semibold text-gray-700 mb-4">Edit Student</h2>
        <form id="addStudentForm" action="{{ route('students.update', $student->id)  }}" method="POST" class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            @csrf
            @method('PUT')
